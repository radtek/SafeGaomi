...
<script>
	var initBMap = function () {
		...
		var proViderPhoneNum = '${proViderPhoneNum}';
		...
		if (lon == '' || lat == '') { //经纬度信息不完整时
			...
			*/
			...
			var opts1 = {title : '<span style="font-size:14px;color:#0A8021">线索基本信息</span> <a  href="#" style="font-size:10px;text-decoration:none;color:#2679BA;float:right" onclick="showDetail();return false;">详情>></a>'};
			
			var content1 = "<div style='line-height:1.8em;font-size:12px;'><b>采集时间:</b>"+collectDate+"</br><b>线索人电话：</b>"+proViderPhoneNum+"</br><img id='cluePhoto' src=\"${ctx}${firstPhotoSrc}\" width=\"150px\" height=\"100px\" ></div>";
