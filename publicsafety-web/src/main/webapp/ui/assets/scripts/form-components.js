var FormComponents = function () {
    ...
    var handleTagsInput = function () {
        ...
        $('#caseTypetreeinputview').tagsInput({
            width: 'auto',
            height: 'auto',
            'defaultText':'',
            'maxChars' : 0 
        ...
        $('#qcaseTypetreeinputview').tagsInput({
            width: 'auto',
            height: 'auto',
            'defaultText':'',
            'maxChars' : 0 //每个标签的最大字符，如果不设置或者为0，就是无限大,
    ...
    var handleSelect2 = function () {
        ...
        $('#unitCode_search').select2({
            placeholder: "Select a State",
            allowClear: true
        });
        
        $('#unitCode_add').select2({
            placeholder: "Select a State",
            allowClear: true
        });
        
        $('#unitCode_edit').select2({
            placeholder: "Select a State",
            allowClear: true
        });
        $('#entrustInfounit').select2({
            placeholder: "Select a State",
            allowClear: true
        });
       
        
        $('#unitCode_batch_add').select2({
            placeholder: "Select a State",
            allowClear: true
        });
        
        $('#dicTypeId_edit').select2({
            placeholder: "Select a State",
            allowClear: true
        });
        
        $('#dicTypeId_add').select2({
            placeholder: "Select a State",
            allowClear: true
        });
