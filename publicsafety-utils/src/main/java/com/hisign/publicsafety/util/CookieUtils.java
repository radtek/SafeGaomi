...
public class CookieUtils
{
	...
	public final static int cookie_expire_time = 60 * 60 * 24 * 7;
     ...
     */
    public static Cookie setCookieForSessionTime(HttpServletRequest request, HttpServletResponse response, String name, String value)
    {
     ...
     * will always try to set this cookie again)
     */
    public static Cookie setCookieForMaxExpireTime(HttpServletRequest request, HttpServletResponse response, String name, String value)
    {
        log.debug("CookieUtils.setCookie " + name + ":" + value);
        Cookie cookie = new Cookie(name, value);
    ...
    public static String getCookieValue(HttpServletRequest request, String name)
    {
        ...
        log.debug("CookieUtils.getCookieValue " + name + ":" + value);
        return value;
    }
    ...
    public static Cookie setURLEncoderCookieForSessionTime(HttpServletRequest request, HttpServletResponse response, String name, String value)
    {
    	if(value != null){
    		try {
        ...
        return setCookieForSessionTime(request, response, name, value);
    }
    
    public static String getDecoderCookieValue(HttpServletRequest request, String name)
    {
